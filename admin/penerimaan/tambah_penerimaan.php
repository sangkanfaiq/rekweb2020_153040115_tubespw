<?php
    ...
    $today = date("Ymd");
    // $query = "SELECT MAX(RIGHT(kode_terima,12)) As akhir FROM tb_penerimaan WHERE RIGHT(kode_terima,12) LIKE '$today%'";
    ...
    $query = "SELECT max(kode_terima) as maxKode FROM tb_penerimaan";
    $hasil = mysqli_query($connect,$query);
    $data = mysqli_fetch_array($hasil);
    $kode_terima = $data['maxKode'];
    $no_urut = (int) substr($kode_terima,3,3);
    $no_urut ++ ;
    $char = "T";
    $kode_terima = $char . sprintf("%04s",$no_urut);
    echo $kode_terima;
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['tambah'])) {
        ...
        $ada = mysqli_query($connect, $cek_data) or die (mysqli_error());
            ...
            if(mysqli_num_rows($ada) > 0) {
                ...
                if($simpan){
                    echo "<meta http-equiv='refresh' content='0 url=?hal=tambah_penerimaan'>";
                }
            }
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['simpan'])) {
        ...
        $simpanData = mysqli_query($connect, "INSERT INTO tb_penerimaan VALUES ('$kode_terima','$today','$jumlah_item','$kode_departement','$id_login','$keterangan')");
        ...
        if($simpanData) {
            ...
            echo "<meta http-equiv='refresh' content='0; url=?hal=data_penerimaan'>";
                        ...
                        <div class="col-md-5">
                            ...
                            <form method="POST" enctype="multipart/form-data" class="form-horizontal style-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" name="kode_terima" value="<?php echo $kode_terima?>" readonly>
                                    </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <form method="POST" enctype="multipart/form-data" class="form-horizontal style-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="?hal=data_penerimaan" class="btn btn-warning">Kembali</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 col-sm-4 control-label">Admin</label>
                                <div class="col-sm-6">
